...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/experiences/manage'); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i>  <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                <thead>
                    <tr>
                        <th> <?php echo lang('global_company') ?></th>
                ...
                <tbody class="middle-align">
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->experience_id ?>">
                            ...
                            <td>
                                <a href="<?php echo site_url('admin/experiences/manage/' . $item->experience_id); ?>" class="btn btn-orange btn-sm">
...
<script type="text/javascript">
    $(".remove").click(function(){
        ...
        {
            $.ajax({
               url: '<?php echo site_url() ?>admin/experiences/delete/'+id,
               type: 'DELETE',
               error: function() {
